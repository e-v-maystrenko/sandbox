...
public class ArrTransformFromEvenToOddByArrsNew {
    public static void main(String[] args) {
        ...
        //Создадим еще два массива четных и нечетных чисел такого же размера, но запишем в них четные и нечетные подряд
        int[] arrayEvenWithout0 = new int[cauntEven];
        int[] arrayOddWithout0 = new int[cauntOdd];
